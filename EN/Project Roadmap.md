...
| Internal name | In the proposal for the client |
| :--- | :--- |
| Roman Purtov | **Project coordinator.** Project management, materials and incentives preparation, recruiting, final report formatting. |
| Margarita Litvin | **Research lead.** Specialist in marketing research and GR in the high-tech sector, over 10 years of hands-on marketing experience (B2C, B2B, B2G). Speaker at intergovernmental commissions of Russia and allied countries. Since 2018 — execution of international projects, including India, UAE, Uzbekistan, Vietnam, and more than 10 other countries. |
| Anastasia | **Senior moderator.** Conducting interviews and focus groups in English (C1 level). International qualitative research experience: Algeria, Iran, Uzbekistan. |
| Dipanshu (Deepanshu) | **Local expert.** Native Hindi speaker, based in India. Assistance with recruiting, respondent communication, and local market specifics. |

### What still needs to be clarified

- [ ] Does Margarita need a briefing on the Indian lending market — and who prepares it?
- [ ] Dipanshu (Deepanshu) — exact scope of involvement, availability, languages?
- [ ] Can we bring in 1 more interviewer as a backup?
...
- Strategic results presentation with the client's team
...
## 4. Step-by-step Work Sequence

> **Key section.** Full picture of "who does what and when" from start to delivery.

### Overall scheme: 6 phases, ~5–6 weeks
...
| # | Step | Responsible | Depends on |
| :---: | :--- | :--- | :---: |
| 0.1 | Agree on roles and format within the team | Roman + Margarita | — |
| 0.2 | Compile proposal for the client | Roman + Margarita | 0.1 |
| 0.3 | Present proposal to the client | Roman + Margarita | 0.2 |
| 0.4 | Receive approval and option selection (B or C) | Client | 0.3 |

```
0.1 Agree on roles -> 0.2 Compile proposal -> 0.3 Presentation -> 0.4 Approval
   [Roman + Margo]      [Roman + Margo]       [Roman + Margo]       [Client]
```

---

### Phase 1: Preparation (days 1–5 after start)
...
```
 ...
 2.6 Schedule [Roman]
       |
       v
 2.7 Pilot [Anastasia + Margo] --> 2.8 Guide adjustment [Margo]
```
...
```
                 +-- 3.1 IDI x 15-20 [Anastasia + Dipanshu] --+
                 |     (~2-3 interviews per day)               |
2.8 Guide ready ->-+                                          +-->  3.4 Transcription [Roman]
                 |                                             |
...
> **Fieldwork pace:** ~2–3 IDI per day, focus group is scheduled separately. The entire phase takes ~2 weeks.

---

### Phase 4: Analysis and report (week 5, ~7–10 days)
...
### Phase 5: Delivery (end of week 6)
...
5.2 Video preparation ----------------+
                                       |
                              5.4 Presentation (Option C)
```

---

### Summary Timeline by Week
...
Prep.     %%%%%%%%%%...
                     ^ everything ready by end of week 1

Recruit.       !!!!!!!!!!!!!!!!!!!!...........
                                         ^ additional recruiting as needed

Pilot                    %%%%
                          ^ 1-2 trial interviews
...
%% - main work     !! - background process     .. - as needed
```
...
Respondents may be talkative, accent may complicate comprehension — a tool with a good AI engine is needed.

| Tool | Pros | Cons |
| :--- | :--- | :--- |
| **Otter.ai** (Pro) | AI summarization, key moment highlighting, text search, Zoom/Meet integration | May perform poorly with Indian English |
| **Fireflies.ai** (Pro) | AI summarization, topic and action item detection, good for accents | — |
| **Trint** | Excellent accuracy, accent support, powerful editor | — |
| **Tactiq** | Live transcription in Google Meet, AI summarization | Basic plan is limited |
...
- **Google Drive** — all recordings, transcripts, documents
- **Notion / Google Sheets** — respondent tracking, statuses, schedule
- **WhatsApp** — communication with respondents (primary channel for this demographic)

---

## 6. Respondent Recruiting

### What is required from a respondent (per brief)

- Lives in India (Tier-1 city: Delhi, Mumbai, Bangalore — or Tier-2: Jaipur, Lucknow, Pune, etc.)
- Has actually used lending apps (confirmed, not self-reported)
- Income ₹15,000–50,000/month
- Does not work in fintech
- Recruit with a +25–30% buffer (no-show rate among Indian respondents ~20–30%)

### Search channels (by priority)
...
| **5** | **Google Play Store — review mining** | Find actual users of KreditBee, MoneyTap, etc. through reviews, reach out directly | **Medium** |
| **6** | **LinkedIn (posts, groups)** | Groups: Indian Fintech, Digital Lending India | **Low–medium** |
| **7** | **MyParticipants** (Indian platform) | Indian native platform, "Bharat-first" approach, worked with Blinkit and financial products | **Medium** |

### Recruiting funnel (Option B)
...
- **Format** — all interviews are conducted online (Zoom / Google Meet)
- **Research working languages** — English, Hindi
- **Project communication** — in Russian
- **Interim status updates** — weekly
